...
GLOBAL OPTIONS:
   ...
   --redirection-url value                   redirection url for the oauth callback url, "*" allows for dynamic redirection, defaults to host header is absent [$PROXY_REDIRECTION_URL]
